...
<div class="grid">
	<form method="get" action="ServerStateSetServlet">
		<div id="one">
			<input type = "submit" class = "operating" value = "启停SMTP服务" name="SmtpState">
		</div>
	</form>
</div>
</br>
<div class="grid">
	<form method="post" action="ServerStateSetServlet">
		<div id="one">
			<input type = "submit" class = "operating" value = "启停POP3服务" name="Pop3state">
		</div>
	</form>
</div>
</div>
