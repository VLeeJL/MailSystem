...
<div class="grid">
	<form onsubmit="return checkMail()" method="post" action="SendMessage">
		<div id="one">
			<label>邮件主题</label>
			<input type = "text" name = "title" placeholder="输入邮件标题" id="mailTitle" value="">
			</br>
			<label id="recList">邮件收件人</label>
			<input type = "text" name = "receiver" placeholder="输入收件人,多个收件人用空格隔开" id="mailRecv" value="">			
			</br>
			<label>邮件正文</label>
			<textarea name="mailContent"style="width:700px ; height:300px" id="mailContent"></textarea>
			</br>
			</br>
